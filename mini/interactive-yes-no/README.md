...
- Clicking **Yes** reveals the final message: "We know you'd come around".

How to use:
1. Open `mini/interactive-yes-no/index.html` in your browser (double-click or serve with a static server).
2. Move your mouse toward the No button and try clicking it. Then click Yes.
